    ...
    DecoratorLinter.prototype.validate = function (imports) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    function checkIfSignaturesMatch(clientMemberName, clientMemberSignature, delegatedArgument) {
                        ...
                        if (clientMemberSignature !== delegatedMemberSignature) {
                            ...
                            diagnostics.push(utilities_1.createErrorDiagnostic(delegatedArgument.filePath, nameRange, message, errors_1.ErrorCode.Four, delegatedArgument.name));
                        }
                        return diagnostics;
                    }
                    ...
                    function checkIfThisCallsAreImplementedInClient(arg) {
                        ...
                        for (var _i = 0, thisCalls_1 = thisCalls; _i < thisCalls_1.length; _i++) {
                            ...
                            if (clientMembersName.indexOf(thisCall.name) < 0) {
                                ...
                                diagnostics.push(utilities_1.createErrorDiagnostic(arg.filePath, nameRange, message, errors_1.ErrorCode.One, arg.name));
                            }
                        }
                        return diagnostics;
                    }
                        ...
                        switch (_g.label) {
                            ...
                            case 2:
                                ...
                                if (source === undefined) {
                                    ...
                                    diagnostics.push(utilities_1.createErrorDiagnostic(importedObject.toLocation, mixinArgument.getNameRange(), message, errors_1.ErrorCode.Five, mixinArgument.name));
                                    return [2 /*return*/, diagnostics];
                                }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    function checkIfMixinPropertiesAreDeclaredInClient(mixinMember) {
                        ...
                        if (!clientHasMixinMember) {
                            ...
                            diagnostics.push(utilities_1.createErrorDiagnostic(client.filePath, nameRange, message, errors_1.ErrorCode.One, client.name));
                        }
                        return diagnostics;
                    }
            ...
            function isMixinImplementingAnInterface(mixin, mixinArgument) {
                ...
                diagnostics.push(utilities_1.createErrorDiagnostic(self.source.fileName, nameRange, message, errors_1.ErrorCode.Two, mixinArgument.name));
                return diagnostics;
            }
